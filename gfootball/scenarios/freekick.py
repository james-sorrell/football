...
def build_scenario(builder):
  ...
  length = round(random.uniform(0.2, 0.6),1)
  width = round(random.uniform(-0.4, 0.4),1)
...
#   length = round(random.uniform(0.5, 0.8),1)
#   width = 0.0 # round(random.uniform(-0.3, 0.3),1)
#   print("Ball Length: {}, Ball Width: {}".format(length, width))
